...
def main(argv):
    ...
    # for dataset in ['weibo', 'msra', 'onto4ner', 'resume']:
    #     convert_ner_corpus_to_txt(corpus_path=f'../data/entity/{dataset}.cn',
    #                               output_path=f'../data/entity/{dataset}.txt')
    compare_two_wordvec_dict(wv_path1='../output/glove/glove_num5.1413.50d',
                             wv_path2='/home/liujian/NLP/corpus/pinyin/word2vec/word2vec_num5.1412.50d')
