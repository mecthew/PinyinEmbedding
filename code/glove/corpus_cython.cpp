...
#define __PYX_HAVE__corpus_cython
#define __PYX_HAVE_API__corpus_cython
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "ios"
...
struct __pyx_t_13corpus_cython_SparseRowMatrix;

/* "corpus_cython.pyx":41
 * 
 * 
...
/* Module declarations from 'corpus_cython' */
...
static CYTHON_INLINE int __pyx_f_13corpus_cython_int_min(int, int); /*proto*/
static int __pyx_f_13corpus_cython_binary_search(int *, int, int, int, int); /*proto*/
static struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_f_13corpus_cython_new_matrix(void); /*proto*/
static void __pyx_f_13corpus_cython_free_matrix(struct __pyx_t_13corpus_cython_SparseRowMatrix *); /*proto*/
static void __pyx_f_13corpus_cython_increment_matrix(struct __pyx_t_13corpus_cython_SparseRowMatrix *, int, int, float); /*proto*/
static int __pyx_f_13corpus_cython_matrix_nnz(struct __pyx_t_13corpus_cython_SparseRowMatrix *); /*proto*/
static PyObject *__pyx_f_13corpus_cython_matrix_to_coo(struct __pyx_t_13corpus_cython_SparseRowMatrix *, int); /*proto*/
static int __pyx_f_13corpus_cython_words_to_ids(PyObject *, std::vector<int>  &, PyObject *, int, int); /*proto*/
...
#define __Pyx_MODULE_NAME "corpus_cython"
extern int __pyx_module_is_main_corpus_cython;
int __pyx_module_is_main_corpus_cython = 0;

/* Implementation of 'corpus_cython' */
...
static const char __pyx_k_corpus_cython[] = "corpus_cython";
...
static PyObject *__pyx_n_s_corpus_cython;
...
static PyObject *__pyx_pf_13corpus_cython_construct_cooccurrence_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_corpus, PyObject *__pyx_v_dictionary, int __pyx_v_supplied, int __pyx_v_window_size, int __pyx_v_ignore_missing); /* proto */
...
static CYTHON_INLINE int __pyx_f_13corpus_cython_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  int __pyx_t_1;
...
static int __pyx_f_13corpus_cython_binary_search(int *__pyx_v_vec, int __pyx_v_size, int __pyx_v_first, int __pyx_v_last, int __pyx_v_x) {
  int __pyx_v_mid;
  int __pyx_r;
  int __pyx_t_1;

  /* "corpus_cython.pyx":24
 *     cdef int mid
 * 
 *     while (first < last):             # <<<<<<<<<<<<<<
 *         mid = (first + last) / 2
...
static struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_f_13corpus_cython_new_matrix(void) {
  struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_v_mat;
  struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_r;
 ...
 *     if mat == NULL:
 */
  __pyx_v_mat = ((struct __pyx_t_13corpus_cython_SparseRowMatrix *)malloc((sizeof(struct __pyx_t_13corpus_cython_SparseRowMatrix))));

  /* "corpus_cython.pyx":55
 *     mat = <SparseRowMatrix*>malloc(sizeof(SparseRowMatrix))
 * 
 *     if mat == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError()
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("corpus_cython.new_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static void __pyx_f_13corpus_cython_free_matrix(struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_v_mat) {
  int __pyx_v_i;
  int __pyx_v_rows;
  int __pyx_t_1;
  int __pyx_t_2;
...
static void __pyx_f_13corpus_cython_increment_matrix(struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_v_mat, int __pyx_v_row, int __pyx_v_col, float __pyx_v_increment) {
 ...
 */
    __pyx_v_idx = __pyx_f_13corpus_cython_binary_search((&((*__pyx_v_row_indices)[0])), __pyx_v_row_indices->size(), 0, __pyx_v_row_indices->size(), __pyx_v_col);
  }
  __pyx_L5:;

  /* "corpus_cython.pyx":109
 * 
 *     # Element to be added at the end
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("corpus_cython.increment_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "corpus_cython.pyx":125
 * 
 * 
...
static int __pyx_f_13corpus_cython_matrix_nnz(struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_v_mat) {
  int __pyx_v_i;
  int __pyx_v_size;
  int __pyx_r;
...
static PyObject *__pyx_f_13corpus_cython_matrix_to_coo(struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_v_mat, int __pyx_v_shape) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_row;
  int __pyx_v_rows;
 ...
 */
  __pyx_v_no_collocations = __pyx_f_13corpus_cython_matrix_nnz(__pyx_v_mat);

  /* "corpus_cython.pyx":151
 * 
 *     # Create the constituent numpy arrays.
 ...
 */
  ...
  __Pyx_AddTraceback("corpus_cython.matrix_to_coo", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __pyx_f_13corpus_cython_words_to_ids(PyObject *__pyx_v_words, std::vector<int>  &__pyx_v_word_ids, PyObject *__pyx_v_dictionary, int __pyx_v_supplied, int __pyx_v_ignore_missing) {
  int __pyx_v_word_id;
 ...
 */
  ...
  __Pyx_WriteUnraisable("corpus_cython.words_to_ids", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13corpus_cython_1construct_cooccurrence_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_13corpus_cython_construct_cooccurrence_matrix[] = "\n    Construct the word-id dictionary and cooccurrence matrix for\n    a given corpus, using a given window size.\n\n    Returns the dictionary and a scipy.sparse COO cooccurrence matrix.\n    ";
static PyMethodDef __pyx_mdef_13corpus_cython_1construct_cooccurrence_matrix = {"construct_cooccurrence_matrix", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13corpus_cython_1construct_cooccurrence_matrix, METH_VARARGS|METH_KEYWORDS, __pyx_doc_13corpus_cython_construct_cooccurrence_matrix};
static PyObject *__pyx_pw_13corpus_cython_1construct_cooccurrence_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("corpus_cython.construct_cooccurrence_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13corpus_cython_construct_cooccurrence_matrix(__pyx_self, __pyx_v_corpus, __pyx_v_dictionary, __pyx_v_supplied, __pyx_v_window_size, __pyx_v_ignore_missing);
...
static PyObject *__pyx_pf_13corpus_cython_construct_cooccurrence_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_corpus, PyObject *__pyx_v_dictionary, int __pyx_v_supplied, int __pyx_v_window_size, int __pyx_v_ignore_missing) {
  struct __pyx_t_13corpus_cython_SparseRowMatrix *__pyx_v_matrix;
 ...
 */
  __pyx_v_matrix = __pyx_f_13corpus_cython_new_matrix();

  /* "corpus_cython.pyx":237
 ...
 *         if error == -1:
 */
    __pyx_v_error = __pyx_f_13corpus_cython_words_to_ids(__pyx_v_words, __pyx_v_word_ids, __pyx_v_dictionary, __pyx_v_supplied, __pyx_v_ignore_missing);

    /* "corpus_cython.pyx":245
 *         error = words_to_ids(words, word_ids, dictionary,
 *                              supplied, ignore_missing)
 *         if error == -1:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_v_window_stop = __pyx_f_13corpus_cython_int_min(((__pyx_v_i + __pyx_v_window_size) + 1), __pyx_v_wordslen);

      /* "corpus_cython.pyx":260
 *             window_stop = int_min(i + window_size + 1, wordslen)
 * 
 *             for j in range(i, window_stop):             # <<<<<<<<<<<<<<
 ...
 *                                      outer_word,
 */
          __pyx_f_13corpus_cython_increment_matrix(__pyx_v_matrix, __pyx_v_inner_word, __pyx_v_outer_word, 1.0);
 ...
 *                                     #  1.0 / (j - i))
 */
          __pyx_f_13corpus_cython_increment_matrix(__pyx_v_matrix, __pyx_v_outer_word, __pyx_v_inner_word, 1.0);
        }
        __pyx_L13:;
        __pyx_L9_continue:;
      }
 ...
 */
  ...
  __pyx_t_1 = __pyx_f_13corpus_cython_matrix_to_coo(__pyx_v_matrix, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 284, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_mat = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "corpus_cython.pyx":285
 *     # Create the matrix.
 *     mat = matrix_to_coo(matrix, len(dictionary))
 *     free_matrix(matrix)             # <<<<<<<<<<<<<<
 * 
 *     return mat
 */
  __pyx_f_13corpus_cython_free_matrix(__pyx_v_matrix);

  /* "corpus_cython.pyx":287
 *     free_matrix(matrix)
 * 
 *     return mat             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "corpus_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "corpus_cython._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_corpus_cython, __pyx_k_corpus_cython, sizeof(__pyx_k_corpus_cython), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_corpus_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "corpus_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "corpus_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     """
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_13corpus_cython_1construct_cooccurrence_matrix, NULL, __pyx_n_s_corpus_cython); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 217, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init corpus_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init corpus_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
