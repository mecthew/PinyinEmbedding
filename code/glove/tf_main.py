...
if __name__ == '__main__':
    ...
    glove = GloVe(n=100, xmax=100, alpha=0.75,
                 max_iter=20000, learning_rate=0.05, tol=1e-4,
                 display_progress=100, log_dir='../../output/tf_glove', log_subdir=None, test_mode=False)
    wordvectors = glove.fit(corpus_obj.matrix)
